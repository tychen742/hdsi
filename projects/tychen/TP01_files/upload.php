<?php
//include "$_SERVER[DOCUMENT_ROOT]/hdsi/includes/headers.php";
...
<div class="container" style="width: 90%; max-width: 900px;">
    <div class="php-message">
        ...
        <?php
        if (isset($email_hdsi)) {
        //        echo $email_hdsi . "WHERE have you been??????? <br>";
        //        echo $username_hdsi . "<br>";
        //        echo $title_project_short;
        $dir = $_SERVER['DOCUMENT_ROOT'] . "/hdsi/projects/$username_hdsi/$tps" . "_files";
        //        echo $dir;
        //                exit;
...
//            header('Location: ' . $_SERVER["HTTP_REFERER"]);
            echo '<meta http-equiv=REFRESH CONTENT=10;url=./projects/' . $username_hdsi . '/' . $tps . '.php>';
            exit();
        }
...
//            echo '<meta http-equiv=REFRESH CONTENT=3;url=http://tychen.us/hdsi/dashboard.php>';
//                exit();
            echo '<meta http-equiv=REFRESH CONTENT=3;url=./projects/' . $username_hdsi . '/' . $tps . '.php>';
