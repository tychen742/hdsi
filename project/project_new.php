...
//  check if Short Title (the project filename) exists
    $check_title = $pdo->query(" SELECT title_project_short FROM projects WHERE 
                    id_creator = '$uid_hdsi' AND title_project_short = '$title_project_short' ");
...
//        touch($filename);
        ...
        try {
            $sql = " INSERT INTO projects (id_creator, title_project, title_project_short, project_description, time_created, date_begin, date_to_complete ) 
                    VALUES ($uid_hdsi, '$title_project', '$title_project_short', '$project_description', '$time_created', $date_begin, $date_to_complete) ";
            $pdo->exec($sql);
...
//            TD: query id_project from projects
        ...
        try {
            $stmt = " INSERT INTO project_user (lead, id_project) VALUES ('$uid_hdsi', $id_project) ";
            $pdo->exec($stmt);
        } catch (PDOException $e) {
