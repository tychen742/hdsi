...
include_once("/var/www/hdsi/includes/utilities.php"); // #### facebook_time
...
$username_hdsi = $_SESSION['username_hbdi'] ?: '';
            ...
            <div class="pane-content">
                ...
                <div id="fileList">
                    ...
                    if (!isset($title_project_short)) {
                        ...
                        $path = $_SERVER['DOCUMENT_ROOT'] . "/projects/$username_hbdi_project/$title_project_short" . "_files/";
                    }
                    $files = scandir($path);
...
<div class="modal" id="publishModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                // TODO: 1) CMS: Make project viewable to the public; 2) Data sharing (sameple rule: Only
                files marked
                as public will be published)
...
include("$_SERVER[DOCUMENT_ROOT]/scripts/modals.php"); // #### modals
