...
$username_hdsi = $_SESSION['username_hdsi'];
            ...
            <div class="section-pane" style="width: 100%">
                ...
                <div class="pane-content">
                    ...
                    if (!isset($title_project_short)) {
                        ...
                        $path = $_SERVER['DOCUMENT_ROOT'] . "/hdsi/projects/$username_hdsi/$title_project_short" . "_files/";
                    }
                    $files = scandir($path);
            ...
            <div class="modal-dialog" style="height: 750px">
                <div class="modal-content" style="height: 200px">
                    ...
                    if (isset($_POST['submitFile'])) {
                        ...
                        $username_hdsi = $_POST['username_hdsi'];
                        error_log("id_project: $id_project; title_project_short: $title_project_short; username_hdsi: $username_hdsi. Variables passed", 0);
...
//                        $tps = $_POST['title_project_short']; // get a different name because it's from the form
                            ...
                            $target_dir = $_SERVER['DOCUMENT_ROOT'] . '/hdsi/projects/' . $username_hdsi . '/' . $tps . '_files';
                            //                    $compliance = implode("; ", $_POST['compliance']); // for later...
//    check Files Directory
//   create Files Directory if non-existent
//                        if ($_SERVER['HTTP_HOST'] == 'hdsinet.us') {
//                        $target_dir = $_SERVER['DOCUMENT_ROOT'] . "/hdsi/projects/" . $username_hdsi . "/" . $tps . "_files";
...
//                        echo "<meta http-equiv=REFRESH CONTENT=5;url=$p/projects/" . $username_hdsi . "/" . $tps . ".php>";
//                        exit();
//                    }
                            ...
                            elseif ($uploadOk == 0) {
                                ...
                                echo "<meta http-equiv=REFRESH CONTENT=1;url=$p/projects/" . $username_hdsi . "/" . $tps . ".php>"; // works
                        ...
                        VALUES('$id_project', '$uid_hdsi', '$passed_file', '$date_uploaded', '$compliance') ");
                                if ($sql->execute()) {
                                    echo "Metadata inserted successfully.";
                                    error_log("Metadata insertion successful. Redirecting to Project page.", 0);
                                    echo "<meta http-equiv=REFRESH CONTENT=1;url=$p/projects/$username_hdsi/$tps.php>";
                                    exit();
                                } else {
                    ...
                    <div style="padding-left: 15px">
                        <form action='' method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="username_hdsi" value=<?php echo $username_hdsi; ?>>
                            <!--                            --><?php //error_log("id_project: $id_project; title_project_short: $title_project_short; username_hdsi: $username_hdsi", 0); ?>
                            <!--                        </div>-->
