...
FROM project_user 
WHERE id_user = '$uid_hdsi' ")->fetchAll();
 ...
 FROM task 
 WHERE (  assigned_to = '$uid_hdsi' OR created_by = '$uid_hdsi')
...
">
                    ...
                    <div class='pane-content'>
                        ...
                        $projects = $pdo->query(" 
 SELECT DISTINCT id_project FROM project_user WHERE id_user = $uid_hdsi ")->fetchAll();
