        ...
        <div class="section-pane" style="width: 100%">
            ...
            <form method="POST" style="display: inline">
                ...
                <div class="pane-content">
                    ...
                    <?php
                    $stmt = $pdo->query(" SELECT DISTINCT id_project FROM project_user WHERE id_user = '$uid_hbdi'")
                        ->fetchAll();
                    foreach ($stmt
                             as $row) {
                        ...
                        foreach ($projects
                            ...
                            $username_hdsi_project = $prj['id_creator'];
                            $username_hdsi_project = $pdo->query("SELECT username FROM user WHERE id_user = $username_hdsi_project")->fetch();
                            $username_hdsi_project = $username_hdsi_project['username'];
                            echo "<div class='content-title'><a href='$p/projects/$username_hdsi_project/$title_project_short.php'>$title_project_short: $title_project</a> </div>";
